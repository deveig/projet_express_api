...
/* Modify a sauce */
exports.changeSauce = async (req, res, next) => {
    try {
        ...
        if (sauce.userId !== req.authentification.userId) {
            ...
            const updatedSauce = await Sauce.updateOne({ _id: req.params.id }, { ...changedSauce, userId: req.authentification.userId }, { runValidators: true });
            if (updatedSauce) {
